...
//-----------------RENDER WINDOW------------------------------------------------------------------------------
    ...
    void RenderWindow::Draw(graphics::RectangleShape rect) const {
        ((sf::RenderWindow*)(window_))->draw(*((sf::RectangleShape*)rect.GetRectangle()));
    }
    void RenderWindow::Draw(sf::RectangleShape rect) const {
        ((sf::RenderWindow*)(window_))->draw(rect);
    }
    void RenderWindow::Draw(sf::VertexArray arr) const {
        ((sf::RenderWindow*)(window_))->draw(arr);
    }
    void RenderWindow::Draw(sf::Text text) const {
